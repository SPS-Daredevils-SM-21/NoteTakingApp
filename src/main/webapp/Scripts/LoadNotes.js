...
function createNoteElement(note){
    ...
    expandElement.innerHTML = EDIT_ICON;
...
function editNote(note){
    ...
    sessionStorage.setItem("Text", note.text);
    sessionStorage.setItem("NoteID", note.id);
    sessionStorage.setItem("Owner", note.userId);
    
    
    document.location.replace("/EditNote.html");
